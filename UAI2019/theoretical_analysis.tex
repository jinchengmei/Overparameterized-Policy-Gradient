...
\begin{equation*}
\begin{split}
    \pr{\left\{ \left\| \hat{\rvr}\left(t\right) - \rvr \right\|_\infty \le \frac{\Delta}{5} \right\}},
\end{split}
\end{equation*}
with probability at least $\frac{2}{t^2}$.
\begin{equation*}
\begin{split}
    ...
    &\quad + \left( \rvo\left( \rmW(t+1) \right) - \hat{\rvr}\left(t\right) \right)^\top \left( \hat{\rvr}\left(t\right) - \hat{\rvr}\left(t+1\right) \right) \\
    &\quad + \frac{1}{2} \left\| \hat{\rvr}\left(t\right) - \hat{\rvr}\left(t+1\right) \right\|_2^2
\end{split}
\end{equation*}
\end{proof}