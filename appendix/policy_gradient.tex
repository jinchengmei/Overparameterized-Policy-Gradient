...
\begin{equation*}
    \lambda_{\max}\left\{ \frac{d \gH\left( \rvpi_i \left(\rvo \right) \right) \rvtilder_i}{d \rvo } \right\} \le 4.
\end{equation*}
\end{lem}
\begin{proof}
...
\begin{split}
    ...
    &\le \int_0^1{  \int_0^1{ \lambda_{\max} \left\{ \frac{d \gH \left( \rvpi_i\left( \rvo + \mu\left( \bar{\rvo}_\xi - \rvo \right) \right) \right) \rvtilder_i }{d \left( \rvo + \mu\left( \bar{\rvo}_\xi - \rvo \right) \right)} \right\} \cdot \left\| \bar{\rvo}_\xi - \rvo \right\|_2 d\mu} \cdot \left\| \rvo^\prime - \rvo \right\|_2 d\xi} \\
    &= \int_0^1{  \int_0^1{ \lambda_{\max} \left\{ \frac{d \gH \left( \rvpi_i\left( \rvo + \mu\left( \bar{\rvo}_\xi - \rvo \right) \right) \right) \rvtilder_i }{d \left( \rvo + \mu\left( \bar{\rvo}_\xi - \rvo \right) \right)} \right\} d\mu} \cdot \xi \cdot \left\| \rvo^\prime - \rvo \right\|_2^2 d\xi} \\
