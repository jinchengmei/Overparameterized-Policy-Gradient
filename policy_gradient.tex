...
\begin{split}
    ...
    &\le 2 \sqrt{m \log{\left(4m\right)}} \cdot \rvpi_i\left( \rmW \right)^\top \rvtilder_i \cdot \left\| \rmW^\prime - \rmW \right\|_F + 4 h m \log{\left(4m\right)} \left\| \rmW^\prime - \rmW \right\|_F^2.
\end{split}
\end{equation*}
