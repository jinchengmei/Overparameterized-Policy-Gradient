...
\begin{equation*}
\begin{split}
	\left\| \frac{d\tilde{\ell}}{d \rvw_r(t)} \right\|_2 \ge \Omega\left( \frac{\delta}{n^2} \right) \cdot \regret\left( \rvpi_{i^*(t)}(t) \right) \ge \Omega\left( \frac{\delta}{n^2} \right) \cdot \regret\left( \rvpi(t) \right).
\end{split}
\end{equation*}
\end{lem}
\begin{proof}
...
\begin{split}
	...
	&\ge \frac{1}{ \sqrt{ 2  \log{ \left( \frac{n}{ \delta \sigma} \right) }} } \cdot \frac{c\tau}{8\sigma n} \cdot \regret(\rvpi(t)),
\end{split}
\end{equation*}
