...
\begin{equation*}
\begin{split}
    \rvpi_i\left( \rmW^\prime \right)^\top \rvtilder_i \le \rvpi_i\left( \rmW \right)^\top \rvtilder_i + 4h \cdot \sqrt{\log{2m}} \cdot m \cdot \left\| \rmW^\prime - \rmW \right\|_F.
\end{split}
\end{equation*}
\end{lem}
\begin{proof}
...
\begin{split}
    ...
    &\quad + 8 \sqrt{m} \cdot \rvpi_i\left( \rmW \right)^\top \rvtilder_i \cdot \left\| \rmW^\prime - \rmW \right\|_F \\
    &+ 8hm \cdot \sqrt{m \log{2m}} \cdot \left\| \rmW^\prime - \rmW \right\|_F^2
\end{split}
\end{equation*}
\end{lem}
\begin{proof}
...
\begin{split}
    ...
    &= 4 \sqrt{m} \cdot \left\| \rmW^\prime - \rmW \right\|_F  \cdot \int_{0}^{1}{ \rvpi_i\left( \bar{\rmW}_\xi \right)^\top \rvtilder_i d\xi} \\
    &\le 4 \sqrt{m} \cdot \left\| \rmW^\prime - \rmW \right\|_F  \cdot \int_{0}^{1}{ \left( \rvpi_i\left( \rmW \right)^\top \rvtilder_i + 4 h m \cdot \sqrt{\log{2m}} \cdot \left\| \bar{\rmW}_\xi - \rmW \right\|_F \right) d\xi} \\
    &\le 4 \sqrt{m} \cdot \rvpi_i\left( \rmW \right)^\top \rvtilder_i \cdot \left\| \rmW^\prime - \rmW \right\|_F + 8 h m \cdot \sqrt{m \log{2m}} \cdot \left\| \rmW^\prime - \rmW \right\|_F^2
\end{split}
\end{equation*}
