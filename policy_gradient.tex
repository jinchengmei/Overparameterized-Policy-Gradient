...
\begin{equation*}
\begin{split}
    \frac{1}{n} \cdot \sum\limits_{i=1}^{n}{  \rvpi_i( \rvo_i^\prime)^\top \rvtilder_i } &\le \frac{1}{n} \cdot \sum\limits_{i=1}^{n}{ \rvpi_i(\rvo_i)^\top \rvtilder_i } + \frac{1}{n} \cdot \sum\limits_{i=1}^{n}{ \left\| \rvtilder_i \right\|_2 \cdot \left\| \rvo_i - \rvo_i^\prime \right\|_2 }.
\end{split}
\end{equation*}
\end{lem}
\begin{proof}
