...
\subsection{Logit Smoothnes}

The convergence of policy expected loss relies on the following result,
...
\begin{split}
    \frac{d \rvpi_i^\top \rvtilder_i}{d \rvo_i} = \left[ \Delta\left( \rvpi_i \right) - \rvpi_i \rvpi_i^\top \right] \rvtilder_i,
\end{split}
\end{equation}
