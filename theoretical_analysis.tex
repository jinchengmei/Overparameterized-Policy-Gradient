...
\label{thm:fake_expected_loss_convergence}
    Assume $m \in \Theta\left( \frac{n^{10}}{c^4 \delta^4 \varepsilon^2} \right)$, $\eta \in \Theta\left( \frac{c_t^2 \delta^2}{8 n^4 h m} \right)$,
    $\rvpi_i\left( \rmW(t) \right)^\top \rvtilder_i \le \frac{n^4}{\eta m c_t^2 \delta^2 t}$.
\end{thm}
\begin{proof}
